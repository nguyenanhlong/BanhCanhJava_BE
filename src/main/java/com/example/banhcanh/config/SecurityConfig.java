    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // ==== CÔNG KHAI: đăng ký/đăng nhập, duyệt xem sản phẩm/danh mục/khuyến
                        // mãi/đánh giá,
                        // xem ảnh, tạo đơn hàng (hỗ trợ khách vãng lai), cổng thanh toán MoMo (không
                        // gắn được JWT) ====
                        ...
                        .requestMatchers(HttpMethod.GET,
                                ...
                                "/api/membership-tiers/**", "/api/upload/presigned")
                        .permitAll()
                        ...
                        // (phải khai báo trước các luật admin-only /api/drivers/** và
                        // /api/delivery-trips/** bên dưới) ====
                        .requestMatchers(HttpMethod.PUT, "/api/drivers/*/status", "/api/drivers/*/location")
                        // Cho phép mọi role)
                        .hasAnyRole("ADMIN", "SUPER_ADMIN", "DRIVER")
                        .requestMatchers(HttpMethod.PUT, "/api/delivery-trips/*/status",
                                "/api/delivery-trips/*/location")
                        .hasAnyRole("ADMIN", "SUPER_ADMIN", "DRIVER")
                        ...
                        .requestMatchers(HttpMethod.PUT,
                                "/api/products/**", "/api/categories/**", "/api/product-options/**",
                                "/api/promotions/**",
                        ...
                        .requestMatchers(HttpMethod.GET,
                                ...
                                "/api/invoice-details/**", "/api/order-history/**", "/api/payments",
                                "/api/payments/order/**",
                        ...
                        // quyền sở hữu (chỉ xem/sửa dữ liệu của chính mình) được kiểm tra thêm trong
                        // controller. ====
